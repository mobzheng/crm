window.verTree = (function () {
    var tree = function (params) {
        ...
        var path = this.getPath,
            common_css_href = path + "../css/common.css?v=1.0&_=" + Math.random(),
            icon_css_href = path + "../css/treeIcon.css?v=1.0&_=" + Math.random(),
    ...
    tree.prototype = {
        ...
        tree_data: function (data, level, cl) {
            ...
            for (var i in data) {
                 ...
                 */
                if (this.type == "form") {
                    icons = "<span><i class='verTreeIcon " + icons_class + " blue ver-tree-check ver-tree-checks'></i><input type='checkbox' v-model='preId' name='" + this.name +  "' value='" + d[this.id] + "' style='display: none' " + checkboxs + "></span> "
                }
